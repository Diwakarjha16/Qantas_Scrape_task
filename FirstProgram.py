...
for _, row in df.iterrows():
    ...
    url = f"https://www.qantas.com/hotels/api/ui/properties/18482/availability?checkIn=2023-11-16&checkOut=2023-11-28&adults=2&children=0&infants=0&payWith=cash"
